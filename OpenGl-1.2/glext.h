...
/*
hello!
these cannot be here since they confilct with the wgl get proc address declarations!
i commented them out since ogl 1.2.1 no supported by ms so we have to get extensions.
