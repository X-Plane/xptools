...
#define GL_APPLE_packed_pixels              1 /* this was corrected from GL_APPLE_packed_pixel in Mac OS X 10.1.5 and earlier */
...
/* Mac OS X v10.1 supports texture rectangle with these constants */
/*
...
/* In Mac OS X v10.2 and later the following constants are used to be compatible with NVIDIA extension constants.
   The 10.1 constants will continue to be supported for backward compatibility */
#if GL_EXT_texture_rectangle
