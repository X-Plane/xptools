/*
	...
	Change History (most recent first):
        ...
        <4+>     8/28/99    ggs
         <4>     7/16/99    ggs     fixed #include for gl and glu
         <3>     7/16/99    ggs     Fixed attributions and copyrights
         <2>     7/16/99    ggs     Removed glutAttachMenuName function
         <1>     6/22/99    ggs     Readded to source control because of project name change
         <4>     5/31/99    GGS
         <3>     5/31/99    ggs     Added glutInitMac, glutCreatePlainWindow, and glutAddnamedMenu
         <2>     5/31/99    ggs     Added initial macintosh compiler switch
         <1>     5/31/99    ggs
*/
...
extern void APIENTRY glutInitMac(int *argcp, char ***argv);
#define glutInit(argcp, argv) glutInitMac((argcp), &(argv))
...
//extern int APIENTRY glutCreatePlainWindow(const char *title);
...
//extern void APIENTRY glutAttachMenuName(int button, char *menu_name);
