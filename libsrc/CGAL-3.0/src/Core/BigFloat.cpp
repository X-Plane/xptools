 ...
 *
 * $Id: BigFloat.cpp,v 1.2 2003/08/06 12:59:30 afabri Exp $
 *****************************************************************/
#include <ctype.h>
...
BigFloatRep::toDecimal(unsigned int width, bool Scientific) const {
  ...
  long lm = M.bitLength();               // binary length of mantissa
...
double BigFloatRep :: toDouble() const
{
  ...
  int len = M.bitLength() - 52;  // this is positive if M is too large
