...
// But is that coordinate is *outside* the area of the default screen, Qt5 automatically takes that as coordinates referring to the
// virtual desktop and places the window at these absoluite coordinates, i.e Qt4 and Qt5 behavior is very different.
