...
// Helper for function pointer type
static WED_Thing* CreateSimpleBoundaryNode(WED_Archive* parent)
{
	return CreateThing<WED_SimpleBoundaryNode>(parent);
}

static WED_Thing* CreateTextureBezierNode(WED_Archive* parent)
{
	return CreateThing<WED_TextureBezierNode>(parent);
}
