...
LDFLAGS_ZLIB		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_LIBEXPAT	:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_LIBPNG		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_FREETYPE	:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_LIBJPEG		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_LIBTIFF		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_LIBPROJ		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_GEOTIFF		:= $(M32_SWITCH) -L$(DEFAULT_LIBDIR) -Wl,-O1
...
LDFLAGS_LIBSQLITE	:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_LIB3DS		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
CFLAGS_CGAL		+= -O3 -frounding-math $(M32_SWITCH) $(DEFAULT_MACARGS)
LDFLAGS_CGAL		:= -L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1
...
CONF_LIBSQUISH		+= CPPFLAGS="$(DEFAULT_MACARGS) -O3 -I$(DEFAULT_INCDIR) $(M32_SWITCH)"
...
LDFLAGS_LIBDIME		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
...
LDFLAGS_LIBSHP		:= "-L$(DEFAULT_LIBDIR) $(M32_SWITCH) -Wl,-O1"
